      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <motion.a
            ...
            className="px-8 py-3.5 sm:px-10 sm:py-4 rounded-full bg-[#25D366] text-white font-semibold text-base sm:text-lg min-h-[44px] flex items-center justify-center gap-2"
